...
with st.sidebar:
    ...
    <div style="background:{T['accent']}11;border:1px solid {T['accent']}33;
        ...
        <div style="font-size:11px;color:{T['muted']};line-height:1.5">
           ...
           <div style="font-size:11px;color:{T['muted']};line-height:1.5">
           Công cụ không chủ động lưu file PDF, MSSV hoặc kết quả tra cứu vào cơ sở dữ liệu; sau khi tải kết quả, người dùng có thể làm mới phiên để xoá dữ liệu tạm.
    </div>""", unsafe_allow_html=True)
